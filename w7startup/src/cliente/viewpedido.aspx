<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/cliente/principal.Master" AutoEventWireup="true" CodeBehind="viewpedido.aspx.cs" Inherits="global.cliente.viewpedido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-title-container">
        <div class="row">
            ...
            <div class="col-12 col-md-10 d-flex align-items-center justify-content-end">
                <asp:Button ID="btnImprimir" CssClass="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto" runat="server" Text="Imprimir" OnClick="btnImprimir_Click" />
            </div>
            <!-- Top Buttons End -->
        </div>
    </div>
            ...
            <div class="row d-flex flex-row align-items-center">
                ...
                <div class="col-12 col-md-6 text-end">
                    ...
                    <div class="text-small text-muted">
                        <asp:Label ID="lblCidadeUf" runat="server" Text=""></asp:Label>
                    </div>
                    <div class="text-small text-muted">
            ...
            <div class="row g-1 mb-5">
                <div class="col-12 col-md-8">
                    <div class="py-3">
                        ...
                        <div>
                            Prazo de Entrega:
                            <asp:Label ID="lblPrazoEntrega" runat="server" Text=""></asp:Label>
                        </div>
                        <div>
                            Data da Entrega:
   ...
   <asp:HyperLink ID="hplNF" runat="server" Target="_blank">Visualizar NF</asp:HyperLink>
                        ...
                        <div>
                            <asp:Label ID="lblDataPedido" runat="server" Text=""></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <div>
                                    <p style="font-size: 14px; text-decoration: none; line-height: 1; color: #7c7c7c; margin-top: 0px; margin-bottom: 0"><%# Eval("qtde") %> unidades</p>
                                </div>
                ...
                <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select pp.idpedido, pp.idproduto, p.titulo, pp.valor, pp.qtde from pedido_produto pp
