<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/lojista/principal.Master" AutoEventWireup="true" CodeBehind="clientes.aspx.cs" Inherits="global.lojista.clientes" %>
...
<i data-acorn-icon="search"></i> Filtrar</asp:LinkButton>     
    ...
    <ItemTemplate>
        <asp:HyperLink ID="lkbContrato" runat="server" Text="Ver Contrato" NavigateUrl='<%# "http://global360.app.br/src/admin/viewcontrato.aspx?id=" + Eval("token")%>'></asp:HyperLink></ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select * from cliente where idtipocliente = 3 and cadastrado_por = @id
