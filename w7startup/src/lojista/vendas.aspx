<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/lojista/principal.Master" AutoEventWireup="true" CodeBehind="vendas.aspx.cs" Inherits="global.lojista.vendas" %>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-auto mb-3 mb-md-0 me-auto">
                        <div class="w-auto sw-md-30">
                            ...
                            <h1 class="mb-0 pb-0 display-4" id="title">Vendas</h1>
                        </div>
                    </div>
                    <!-- Title End -->
                    ...
                    <div class="col-12 col-sm-6 col-md-auto d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
                        <asp:LinkButton ID="lkbAdicionarPerfil" runat="server" CssClass="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto" OnClick="LinkButton1_Click">
                         <i data-acorn-icon="plus"></i> Nova Venda</asp:LinkButton>
                    </div>
                    <!-- Top Buttons End -->
                </div>
            </div>
                ...
                <div class="col-12 mb-5">
                    <asp:GridView ID="gdvDados" runat="server" Width="100%" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" EmptyDataText="Não há dados para visualizar" DataSourceID="sdsDados" OnRowCommand="gdvDados_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button data-bs-offset="0,3" data-bs-toggle="modal" data-bs-target="#discountAddModal" ID="btnCancelar" CssClass="btn btn-icon btn-icon-end btn-danger" CommandArgument='<%# Eval("id") %>' CommandName="Cancelar" runat="server" Text="Cancelar" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
...
<br />
                            ...
                            <div class="modal-footer border-0">
                                <asp:Label ID="lblConfirma" runat="server" Text=""></asp:Label><br />
                              <asp:Button ID="btnConfirmar" CssClass="btn btn-icon btn-icon-end btn-success" runat="server" Text="Confirmar" OnClick="btnSalvar_Click1" />
