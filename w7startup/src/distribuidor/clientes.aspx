<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/distribuidor/principal.Master" AutoEventWireup="true" CodeBehind="clientes.aspx.cs" Inherits="global.distribuidor.clientes" %>
     ...
     <ItemTemplate>
         <asp:Button data-bs-offset="0,3" data-bs-toggle="modal" data-bs-target="#discountAddModal" ID="btnEditar" CssClass="btn btn-icon btn-icon-end btn-primary" CommandArgument='<%# Eval("id") %>' CommandName="Editar" runat="server" Text="Editar" /></ItemTemplate>
                            ...
                            <asp:BoundField DataField="datacadastro" HeaderText="Desde de" SortExpression="datacadastro" />
                                                        <asp:TemplateField>
    <ItemTemplate>
        <asp:HyperLink ID="lkbContrato" runat="server" Text="Ver Contrato" NavigateUrl='<%# "viewcontrato.aspx?id=" + Eval("token")%>' Target="_blank"></asp:HyperLink></ItemTemplate>
</asp:TemplateField>
                        </Columns>
