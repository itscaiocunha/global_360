<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/distribuidor/principal.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="global.distribuidor.dashboard" %>
...
order by datacadastro desc">
    ...
    <div class="row gx-4 gy-5">
        ...
        <div class="col-xl-6 mb-5">
            <h2 class="small-title">Últimos Lojistas Cadastrados</h2>
...
where idtipocliente in(1,2) and cadastrado_por = @id
order by datacadastro desc">
                                                                        <SelectParameters>
                                                    <asp:SessionParameter Name="id" SessionField="idcliente" />
</SelectParameters>
...
order by datacadastro desc">                                                <SelectParameters>
                                                    <asp:SessionParameter Name="id" SessionField="idcliente" />
