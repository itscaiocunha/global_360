<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/distribuidor/principal.Master" AutoEventWireup="true" CodeBehind="lojistas.aspx.cs" Inherits="global.distribuidor.lojistas" %>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-auto mb-3 mb-md-0 me-auto">
                        <div class="w-auto sw-md-30">
                            ...
                            <h1 class="mb-0 pb-0 display-4" id="title">Lojista</h1>
                        </div>
                    </div>
                    <!-- Title End -->
...
<i data-acorn-icon="search"></i> Filtrar</asp:LinkButton>     
     ...
     <ItemTemplate>
         <asp:Button data-bs-offset="0,3" data-bs-toggle="modal" data-bs-target="#discountAddModal" ID="btnEditar" CssClass="btn btn-icon btn-icon-end btn-primary" CommandArgument='<%# Eval("id") %>' CommandName="Editar" runat="server" Text="Editar" /></ItemTemplate>
                            ...
                            <asp:BoundField DataField="nomecompleto" HeaderText="Lojista" SortExpression="nomecompleto" />
    ...
    <ItemTemplate>
        <asp:HyperLink ID="lkbContrato" runat="server" Text="Ver Contrato" NavigateUrl='<%# "http://global360.app.br/src/admin/viewcontrato.aspx?id=" + Eval("token")%>'></asp:HyperLink></ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select * from cliente where idtipocliente = 2
and cadastrado_por = @id
order by nomecompleto">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="hdfIdUsuario" Name="id" PropertyName="Value" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Lojista</h5>
                        </div>
    ...
    <label class="form-label">
        Concluíndo este cadastrado, está confirmando que aceita as políticas do <asp:HyperLink ID="hplTermoUso" NavigateUrl="https://www.global360.app.br/src/termo.pdf" runat="server">Termo de Uso</asp:HyperLink> do sistema</label>
