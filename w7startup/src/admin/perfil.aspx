<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="perfil.aspx.cs" Inherits="global.perfil" %>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-auto mb-3 mb-md-0 me-auto">
                        <div class="w-auto sw-md-30">
                            ...
                            <h1 class="mb-0 pb-0 display-4" id="title">Tipo de Cliente</h1>
                        </div>
                    </div>
                    <!-- Title End -->
                ...
                <div class="col-12 mb-5">
                    <asp:GridView ID="gdvDados" runat="server" Width="100%" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" EmptyDataText="Não há dados para visualizar" DataSourceID="sdsDados" OnRowCommand="gdvDados_RowCommand">
                        <Columns>
                            ...
                            <asp:BoundField DataField="descricao" HeaderText="Nome do Perfil" SortExpression="descricao" />
                    ...
                    <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select * from tipo_cliente"></asp:SqlDataSource>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Adicionar Tipo de Cliente</h5>
                        </div>
