    ...
    public partial class perfil : System.Web.UI.Page
    {
        ...
        protected void gdvDados_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            using (IDataReader reader = DatabaseFactory.CreateDatabase("ConnectionString").ExecuteReader(CommandType.Text,
                          "SELECT * from tipo_cliente where id = '" + hdfId.Value + "'"))
            {
                if (reader.Read())
                {
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (hdfId.Value == "")
            {
                ...
                "INSERT INTO tipo_cliente (descricao, status) values (@descricao, @status)");
            ...
            {
                DbCommand command = db.GetSqlStringCommand(
               "UPDATE tipo_cliente SET descricao = @descricao, status = @status where id = @id");
        ...
        {
            sdsDados.SelectCommand = "select * from tipo_cliente where descricao like '%" + txtBuscar.Text+"%'";
            gdvDados.DataBind();
        }
    }
}