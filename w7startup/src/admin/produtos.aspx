<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="produtos.aspx.cs" Inherits="global.produtos" %>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-auto mb-3 mb-md-0 me-auto">
                        <div class="w-auto sw-md-30">
                            ...
                            <h1 class="mb-0 pb-0 display-4" id="title">Produtos</h1>
                        </div>
                    </div>
                    <!-- Title End -->
...
<i data-acorn-icon="search"></i> Filtrar</asp:LinkButton>     
    ...
    <ItemTemplate>
        <asp:Image ID="Image1" ImageAlign="AbsMiddle" Width="50px" ImageUrl='<%# Eval("imagem") %>' runat="server" />
                            ...
                            <asp:BoundField DataField="descricao1" HeaderText="Categoria" SortExpression="descricao1" />
                            <asp:BoundField DataField="titulo" HeaderText="Nome do Produto" SortExpression="titulo" />                            
...
order by p.titulo"></asp:SqlDataSource>
    ...
    <asp:DropDownList ID="ddlCategoria" runat="server" CssClass="form-control shadow dropdown-menu-end" DataSourceID="sdsCategoria" DataTextField="descricao" DataValueField="id">
        ...
        <asp:SqlDataSource ID="sdsCategoria" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select id, descricao from categoria"></asp:SqlDataSource>
</div>
                        <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <asp:TextBox ID="txtDescricao" TextMode="MultiLine" Rows="5" runat="server" CssClass="form-control"></asp:TextBox>
    </div>
    <div class="mb-3">
        <label class="form-label">Valor(R$)</label>
        <asp:TextBox ID="txtValor" onkeyup="formataMoeda(this,event);" runat="server" CssClass="form-control"></asp:TextBox>
    </div>
                    
    <div class="mb-3">
        <label class="form-label">Imagem</label>
        <asp:FileUpload ID="fluImagem" CssClass="form-control" runat="server" /><br />
        <asp:Image ID="imgFoto" ImageAlign="AbsMiddle" ImageUrl="~/src/img/produto-sem-imagem.jpg" runat="server" Width="100px" />
    </div>
