<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="vendas.aspx.cs" Inherits="global.vendas" %>
            ...
            <div class="row">
                <div class="col-12 mb-5">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
    <ItemTemplate>
        <asp:Button ID="btnCancelar" CssClass="btn btn-icon btn-icon-end btn-danger" CommandArgument='<%# Eval("id") %>' CommandName="Cancelar" runat="server" Text="Cancelar" />
    </ItemTemplate>
</asp:TemplateField>
                            <asp:TemplateField>
    <ItemTemplate>
