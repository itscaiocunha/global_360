<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="faturas.aspx.cs" Inherits="global.faturas" %>
            ...
            <div class="row">
                <div class="col-12 mb-5">
                    ...
                    <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand=
                        "select f.idpedido, c.nomecompleto, f.valor, f.[status], f.datavencimento, f.datapagamento 
                        from fatura f
