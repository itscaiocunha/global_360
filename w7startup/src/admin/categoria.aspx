<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="categoria.aspx.cs" Inherits="global.categoria" %>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-auto mb-3 mb-md-0 me-auto">
                        <div class="w-auto sw-md-30">
                            ...
                            <h1 class="mb-0 pb-0 display-4" id="title">Categoria</h1>
                        </div>
                    </div>
                    <!-- Title End -->
...
<i data-acorn-icon="search"></i> Filtrar</asp:LinkButton>     
            ...
            <div class="row">
                <div class="col-12 mb-5">
                    ...
                    <asp:SqlDataSource ID="sdsDados" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select * from categoria"></asp:SqlDataSource>
                </div>
            </div>
