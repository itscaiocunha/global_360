<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/src/admin/principal.Master" AutoEventWireup="true" CodeBehind="lojistas.aspx.cs" Inherits="global.admin.lojistas" %>
...
order by nomecompleto"></asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sdsDistribuidor" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select id, nomecompleto from cliente"></asp:SqlDataSource>
</div>
</div>
